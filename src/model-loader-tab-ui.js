//	model-loader-tab-ui.js

	TabUI.add( "ModelLoader", "model-loader-tab" ); TabUI.append( "ModelLoader" ); TabUI.ModelLoader.pill.innerHTML = "Model&nbsp;Loader";

//	model-loader-collection-droplist-ui.js

	(function( tab ){

	//	ModelLoader Collections droplist.

		var row = document.createElement("h3"); 
		row.textContent = "Collection:"; row.style.cssText = "height:30px;"

		var select = document.createElement("select"); select.id = "model-loader-collection-droplist";
		...
		var keys = "animals,bathroom,bedroom,doors,walls,windows,floor,kitchen,lights,";
		keys += "office,livingroom,staircases,vehicles,exterior,trees,characters,miscellaneous";
...
//	model-loader-viewer-ui.js
	...
	//	canvas.style.cssText += "background-repeat:repeat;background-image:url('https://i.imgur.com/rnZZU0i.png') !important;";
		var img = new Image(256,256); img.id = "model-loader-image-viewer"; img.src = ":0"; img.style.cssText = "margin:0 30px;display:none;"; 
...
//	model-loader-load-button-ui.js
