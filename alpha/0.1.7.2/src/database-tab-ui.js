//	database-tab-ui.js
	...
	//	Database droplist.
		...
		var row = document.createElement("h3"); row.textContent = "Database:"; row.style.cssText = "height:30px;"
		var select = document.createElement("select"); select.id = "database-droplist";
		...
		row.appendChild( select ); tab.appendChild( row ); return select;
...
//	collection-droplist-ui.js
	...
	//	Collection droplist.
		...
		var select = document.createElement("select"); select.id = "collection-droplist";
		select.style.cssText  = "width:150px;color:#000;float:right;border:1px solid;border-radius:4px;";
		select.style.cssText += "padding:2px 4px 4px 4px;font-size:20px;margin-left:10px;margin-right:15px;";
...
//	value-input-ui.js
	...
	//	Document Value input.
		...
		var row = document.createElement("h3"); row.textContent = "value:";
